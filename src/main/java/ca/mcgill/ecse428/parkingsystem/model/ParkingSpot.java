...
public class ParkingSpot
{
  ...
  public ParkingSpot(String aPKey, int aStreet_Number, String aSteet_Name, String aPostal_Code, float aAvg_Rating, float aCurrent_Price, User aUser, ParkingManager aParkingManager)
  {
    pKey = aPKey;
  ...
  public Reservation addReservation(String aPKey, String aVehicle_Plate, Date aStart_Date, Date aEnd_Date, float aPrice_Paid, int aStart_Time, int aEnd_Time, User aUser, ParkingManager aParkingManager)
  {
    return new Reservation(aPKey, aVehicle_Plate, aStart_Date, aEnd_Date, aPrice_Paid, aStart_Time, aEnd_Time, aUser, aParkingManager, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public Review addReview(float aRating, String aComment, ParkingManager aParkingManager)
  {
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "steet_Name" + ":" + getSteet_Name()+ "," +
            "postal_Code" + ":" + getPostal_Code()+ "," +
            "avg_Rating" + ":" + getAvg_Rating()+ "," +
            "current_Price" + ":" + getCurrent_Price()+ "]" + System.getProperties().getProperty("line.separator") +
