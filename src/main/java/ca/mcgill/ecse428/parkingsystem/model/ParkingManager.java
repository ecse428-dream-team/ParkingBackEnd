...
public class ParkingManager {
	...
	@OneToMany(mappedBy = "parkingManager", cascade = { CascadeType.ALL })
	...
	public User addUser(String aFist_Name, String aLast_Name, String aUserID, String aPassword, String aEmail,
			boolean aIsRenter, boolean aIsSeller) {
	...
	public boolean addAdminAt(Admin aAdmin, int index) {
		...
		if (addAdmin(aAdmin)) {
			...
			if (index > numberOfAdmins()) {
				index = numberOfAdmins() - 1;
			}
			admins.remove(aAdmin);
	...
	public String toString() {
		return super.toString() + "[" + "pKey" + ":" + getPKey() + "]";
	}
}